...
class APIConfigLoader:
    ...
    def _apply_env_overrides(self):
        ...
        api_key_patterns = [
            ...
            ('DASHSCOPE_API_KEY', 'providers', 'dashscope', 'api_key_env'),
            ('MINIMAX_API_KEY', 'providers', 'minimax', 'api_key_env'),
            ('ANTHROPIC_API_KEY', 'providers', 'anthropic', 'api_key_env'),
            ('GEMINI_API_KEY', 'providers', 'gemini', 'api_key_env'),
            ('DEEPSEEK_API_KEY', 'providers', 'deepseek', 'api_key_env'),
            ('VOLCANO_API_KEY', 'providers', 'volcano', 'api_key_env'),
        ]
        
        for env_var, *path in api_key_patterns:
            api_key = os.getenv(env_var)
            if api_key:
                self._set_nested_value(path, api_key)
